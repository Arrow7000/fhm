...
| FHM/SurfaceBridge.lean | letRecInAnn (114xx) | **deferred at the D2 checkpoint**: the surface ctor's premises are scheme-relative for annotated members (`τretPolyOf`); a witness-based restatement of the SURFACE rule is required. The later group-tier checkpoint supplies that restatement. |
